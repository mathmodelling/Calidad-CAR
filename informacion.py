...
DOC_PATH = "file:///" + os.path.join(os.path.dirname(__file__), 'docs', 'index.html').replace('\\','/')
...
class InformationDialog(QtGui.QDialog, Ui_Dialog):
    ...
    def __init__(self, parent = None):
        ...
        info = "<a href=\"%s\">%s%s%s</a>" % (PLUGIN_URL, style_open, u"Información de desarrollo", style_close)
        text = "<a href=\"%s\">%s%s%s</a>" % (DOC_PATH, style_open, u"Documentación", style_close)
